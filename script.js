...
const phrases = [
    "Sonríe, es terapia gratis.", "Cree en ti y todo será posible.", "La vida es un lienzo, dibuja tu paraíso.",
    "La imaginación nos hace infinitos.", "Vive, ama, ríe.", "Sigue tus sueños, ellos saben el camino.",
    "La felicidad es un viaje, no un destino.", "Eres más fuerte de lo que piensas.", "La magia está en creer.",
    "El amor es la poesía de los sentidos.", "Siembra un pensamiento, cosecha una acción.", "El futuro pertenece a quienes creen.",
    "La mejor forma de predecir el futuro es crearlo.", "El código te da el poder." // Frase extra
];
