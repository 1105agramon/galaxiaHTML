...
// Lista de frases a usar
const phrases = [
    "Perla, eres mi estrella más brillante. ✨",
    "Cada momento contigo es mi universo favorito. 🪐",
    "Tu amor es la melodía que mi alma anhela. 🎶",
    "Perla, tu sonrisa ilumina mi galaxia entera. 🌟",
    "Contigo, cada día es una nueva aventura espacial. 🚀",
    "Mi corazón es tuyo, Perla, en cada órbita. ❤️‍🔥",
    "Eres el planeta que quiero explorar eternamente. 🌍",
    "A tu lado, el tiempo se detiene y el espacio se expande. ⏳",
    "Perla, mi amor por ti es infinito como el cosmos. 🌌",
    "No hay distancia que opaque lo que siento por ti. 💖",
    "Tú y yo, un amor digno de las constelaciones. 💫",
    "Eres el sol que da calor a mi existencia. ☀️",
    "Perla, cada latido mío lleva tu nombre grabado. 💘",
    "Nuestra historia, un cuento de hadas intergaláctico. 🧚‍♀️",
    "Me pierdo en tus ojos como en un cielo estrellado. 👀",
    "Eres la gravedad que me mantiene anclado a la felicidad. 😊",
    "Perla, eres el sueño hecho realidad en mi universo. 🌠",
    "Juntos, navegando por las nebulosas del amor. ⛵",
    "Tu voz, un eco suave en mi espacio personal. 🗣️",
    "Eres la magia que transforma mi realidad. ✨",
    "Perla, mi vida es un mejor lugar desde que llegaste. 🏡",
    "El universo conspiró para unirnos, mi amor. 🤞",
    "Contigo, el futuro es más brillante que cualquier supernova. 💥",
    "Perla, eres la respuesta a todas mis plegarias cósmicas. 🙏",
    "Gracias por existir, mi amor, mi todo. 🙏",
    "Cada pensamiento mío vuela hacia ti como un cometa. ☄️",
    "Eres mi puerto seguro en esta inmensa galaxia. ⚓",
    "Perla, eres la razón de mi alegría más pura. 😄",
    "Tu presencia es un regalo del cielo. 🎁",
    "Nuestro amor es el más grande de todos los misterios. 🤫",
    "Contigo, la vida es una obra de arte espacial. 🎨",
    "Perla, te amo más allá de las palabras y las estrellas. 💜",
    "Eres la chispa que enciende mi universo interior. 🔥",
    "Mi amor por ti es tan vasto como el espacio mismo. 🪐",
    "Perla, cada detalle tuyo me enamora más. 😍",
    "Quiero explorar el universo de tu mano. 👫",
    "Eres mi dulce melodía en el silencio del espacio. 🎶",
    "Perla, mi mayor deseo es tu felicidad. 🥰",
    "Contigo, no hay oscuridad que me detenga. 💡",
    "Eres el faro que guía mi camino. 🧭",
    "Perla, eres mi destino, mi presente y mi futuro. 💖",
    "Nuestro amor es una danza cósmica perfecta. 💃🕺",
    "Tu risa es la música que adoro. 😂",
    "Perla, simplemente eres mi todo. 💫",
    "Mi corazón late solo por ti, siempre. 💓",
    "Eres la maravilla de mi existencia. 🤩",
    "Contigo, cada día es un nuevo amanecer. 🌅",
    "Perla, te elegiría una y mil veces en este universo. ♾️",
    "Eres mi constelación favorita, Perla. 🌠",
    "Mi amor por ti no tiene límites, como el espacio. 🌌"
];
...
function createTextTexture(text) {
    ...
    context.fillStyle = 'rgba(148, 0, 0, 1)';
